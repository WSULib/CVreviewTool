...
?>
 	<div id="page_content">
 		<?php
			...
			echo "<a href='reportv2.php?author_id=$author_id'>Back to Report</a></br>";
?></div>
...
// write pdf report
$cmd_string = "./wkhtmltopdf-amd64 $base_url/report_outputv2.php?author_id=$author_id ./pdfs/$author_name_pdf_safe.pdf";
exec($cmd_string);
